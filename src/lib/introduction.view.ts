...
const paragraphs = [
    ...
    `It comes as a complementary solution to traditional cloud computing platforms that often suffer from limitations such as rigidity, complexity, and high cost. 
     Unlike traditional platforms, YouWol operates by executing algorithms on the user's device within a browser. This approach may not always be applicable,
